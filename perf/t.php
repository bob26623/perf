...
$auth_users = array(
    'alice' => '$2y$10$woP4R87BdekD0d77ZAZqMOg1WB5yQW2ny14Tl0iSrU6Klofs76HcW',
    'admin' => '$2y$10$UOkq1atJWf7F.ED0MhfBROFXi5rfnv54Gpa1Lsw0Geo/VVaNWVMne', //admin@123
    'user' => '$2y$10$DkBfxIjf.xxMcAeSEqFILuxs/.5PosIWIz7R7eE.tRZfVqRLKZndW' //12345
);
...
$favicon_url = ($is_https ? 'https' : 'http') . '://' . $http_host . $_SERVER['PHP_SELF'];
...
global $lang, $root_url, $favicon_url;
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="icon" href="<?php echo $favicon_url ?>?img=favicon" type="image/png">
...
global $lang, $root_url, $favicon_url, $sticky_navbar;
