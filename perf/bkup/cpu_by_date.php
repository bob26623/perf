<?php
 ...
 $Test->drawFilledRectangle(0,0,950,370,$Settings); 

 /* Overlay with a gradient */ 
 $Settings = array("StartR"=>219, "StartG"=>231, "StartB"=>139, "EndR"=>1, "EndG"=>138, "EndB"=>68, "Alpha"=>50);
 $Test->drawGradientArea(0,0,950,370,DIRECTION_VERTICAL,$Settings); 
 ...
 $Test->drawRectangle(0,0,949,369,array("R"=>0,"G"=>0,"B"=>0)); 
 ...
 $Test->setGraphArea(60,50,900,320); 
